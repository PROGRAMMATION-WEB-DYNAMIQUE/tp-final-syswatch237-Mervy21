...
fn machines() -> HashMap<String, String> {
    ...
    m.insert("PC-01-DARELLE".to_string(), "192.168.0.105".to_string());
    m.insert("PC-02-MERVEILLES".to_string(), "192.168.1.131".to_string());
    m.insert("PC-03-CASSANDRA".to_string(), "10.0.0.96".to_string());
